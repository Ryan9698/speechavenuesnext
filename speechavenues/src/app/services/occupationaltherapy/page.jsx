            ...
            <div className="">
              <div className="w-full md:mt-10">
                ...
                <p className="mt-2 px-8 text-center md:text-left">
                  Occupational Therapy is a patient-centered profession that
                  focuses on improving a person’s ability to perform everyday
                  tasks. Through personalized treatment plans, OT helps
                  individuals regain skills, build strength, and overcome
                  challenges that impact their daily lives. Our therapists do
                  not just treat the symptoms, we consider the whole person and
                  their environment to ensure they can thrive at home, school,
                  work, and within other areas of the community.
                </p>
              </div>
              ...
              <div className="container flex flex-col md:flex-row gap-4 md:mt-8 md:mb-10">
                ...
                <div className="flex flex-col md:basis-2/3 order-first md:order-last">
                  ...
                  <ul className="list-disc pl-5 space-y-2 px-8 text-sm">
                    <li>
                      Occupational Therapy was founded in 1917, originally
                      developed as a form of therapeutic intervention for
                      soldiers returning from World War I who were dealing with
                      physical and mental challenges. ~ American Occupational
                      Therapy Association (AOTA), “History of Occupational
                      Therapy”(2023)
                    </li>
                    <li>
                      Occupational Therapy doesn’t just focus on physical
                      health- OTs also address mental health by helping
                      individuals develop coping strategies, manage anxiety, and
                      build routines for emotional well-being. ~ American
                      Occupational Therapy Association (AOTA) ~ “OTs Role in
                      Mental Health”(2022)
                    </li>
                  </ul>
                </div>
              ...
              <div className="container mx-auto mt-12 md:mt-0">
                ...
                <div className="px-8 mb-3 text-center md:text-left">
                  <p>
                    Our Occupational Therapists address a wide range of
                    conditions, from developmental delays/disorders to physical
                ...
                <div>
                  ...
                  <ul className="flex flex-col list-disc pl-5 space-y-6 text-sm md:mb-8 mb-10">
                    <li className="px-4">
                      <strong>Sensory Processing Disorder (SPD):</strong> SPD
                      may have difficulty processing sensory input, which can
                      lead to behavioral challenges, difficulty focusing, or
                      aversions to textures and sounds. Through sensory
                      integration therapy, OT will help regulate sensory
                      experiences and improve the ability to participate in
                      daily activities.
                    </li>
                    <li className="px-4">
                      <strong>
                        Autism Spectrum Disorder (ASD) / Neurodivergent
                        Individuals:
                      </strong>
                      ...
                      programs that focus on improving interaction, enhancing
                      motor skills, and building independence through sensory
                      and motor activities tailored to each person's strengths.
                    </li>
                    ...
                    <div className="flex flex-col md:flex-row m-auto">
                      <div className="md:basis-2/3 space-y-6 lg:space-y-8 lg:mt-3 pr-6 lg:mb-4 mb-8 md:mb-0">
                        <li className="px-4">
                          ...
                          motor skills, speech, or daily self-care tasks.
                          Through play-based therapy and exercises tailored to
                          developmental milestones, we help children gain
                          confidence and achieve greater independence at home
                          and school.
                        </li>
                        <li className="px-4">
                          <strong>
                          ...
                          disruptions in coordination, attention, and/or memory.
                          Our therapists focus on promoting safety, managing
                          triggers, and teaching compensatory techniques for
                          cognitive and motor challenges. We help individuals
                          develop strategies to regain independence in daily
                    ...
                    <li className="px-4">
                      ...
                      Learning disabilities can impact a child’s ability to
                      perform school tasks, such as reading, writing, or
                      processing and retaining information. Our therapists use a
                      combination of cognitive strategies, handwriting training,
                      and adaptive learning tools to improve academic
                      performance and boost confidence. We also provide support
                      for organizational and study skills to help better manage
                    ...
                    <li className="px-4">
                      ...
                      conditions like tendonitis, or rehabilitating after
                      surgery, orthopedic injuries can limit a certain range of
                      motion and strength.
                    </li>
                    <li className="px-4">
                      <strong>Cerebral Palsy:</strong> Patients with cerebral
                      palsy may have difficulties with movement, balance, or
                      coordination. Through therapeutic exercises, assistive
                      devices, and adaptive strategies, we help improve motor
                      function, enabling greater independence in daily tasks
                      like dressing, eating, or work/school activities.
                    </li>
                    <li className="px-4">
                      <strong>Traumatic Brain Injury (TBI):</strong> TBI can
                      lead to both physical and cognitive impairments, such as
                      memory loss or decreased coordination. We provide
                      cognitive rehabilitation and retrain motor skills, helping
                      patients regain their functional independence and
                  ...
                  <div className="flex flex-col md:flex-row items-center md:items-start md:gap-6">
                    <div className="flex-1 text-center md:text-left mt-6 md:mt-8 lg:mt-20">
                      ...
                      <p className="px-8 text-center mb-4 md:mb-0">
                        At Speech Avenues Therapy Co, we are committed to making
                        a difference. Our team of experienced therapists use
                ...
                <p className="px-8 mb-10 text-center md:text-left">
                  ...
                  tools and environment is essential for effective therapy. That
                  is why our facility is designed to provide a welcoming, fully
                  equipped space where patients can achieve their goals. We are
                  proud to offer a range of specialized equipment, a vibrant
                  sensory gym full of swings, trampolines, ball pits, and
                  one-on-one therapy rooms to ensure privacy and comfort for
                  each patient.
                </p>
                ...
                <p className="px-8 mb-4 text-center md:text-left">
                  ...
                  therapy can transform your life and the life of your loved
                  one. Your goals are within reach ~ let us help you achieve
                  them!
                </p>
              </div>
            </div>
