...
//               <p className="mb-4">
//                 By collaborating with patients to set personalized goals and
//                 develop tailored treatment plans, occupational therapy
//                 facilitates individuals' engagement in daily activities,
//                 promotes overall well-being, and maximizes independence across
//                 all life domains.
//               </p>
//               <p className="mb-4">
//                 At SATC, supporting individuals in reaching their fullest
...
//               </a>
//               <p className="mt-4 mb-4 font-medium">
//                 Services provided by our occupational therapists encompass a
//                 wide range of interventions, including: assessing and improving
//                 fine motor skills, balance, emotional regulation, self-care
...
//                 <ul className="list-disc pl-5 mt-2">
//                   <li className="mb-2">
//                     Sensory integration is the brain's ability to process and
...
//               </a>
//               <p className="mt-4">
//                 Lastly, being able to work alongside our wonderful
//                 Speech-Language Pathologists (SLPs), our Occupational Therapists
//                 are able to support and treat individuals in improving speech,
//                 language techniques, communication, and expression skills by
//                 addressing possible underlying sensory and motor components.
//               </p>
//             </div>
//           </div>
//         </div>
