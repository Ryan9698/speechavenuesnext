...
const header = `font-bold text-gray-800 mt-8 font-dancing mx-auto text-center md:text-left md:mt-2`;
    ...
    <div className="container mx-auto p-4 max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2">
          <div className="">
            <h1 className="text-4xl font-bold text-gray-800 font-dancing text-center md:text-left">
              Occupational Therapy (OT):
            </h1>
            <h2 className="text-xl font-dancing text-gray-800 text-center md:text-left">
              Empowering Lives, One Session at a Time
            </h2>
            <p className="mt-4">
              At Speech Avenues Therapy Co, we specialize in occupational
              therapy (OT) services that help individuals of all ages live life
              to the fullest.
            </p>
            <p className="mt-2">
              ...
              regulation, OT is designed to make life more accessible and
              enjoyable.
            </p>
          </div>
          <div className="">
            <h3 className={`${header} text-2xl mt-2`}>
      ...
      {/* Fun Facts Section */}
      <div className="p-2">
        <h2 className={`${header} text-2xl mb-2`}>Fun Facts:</h2>
      ...
      <div className="container mx-auto p-6">
        {/* What Do We Treat Section */}
        <h2 className={`${header} text-2xl`}>What Do We Treat?</h2>
        <p>
        ...
        <ul className="list-disc pl-5 space-y-4">
          ...
          <li>
            <strong>Neurological Disorders (e.g., Seizures / Epilepsy):</strong>
        ...
        <h2 className={`${header} text-2xl`}>Why Choose Us?</h2>
        <p>
          At Speech Avenues Therapy Co, we are committed to making a difference.
          Our team of experienced therapists use approaches created for
          personalized treatment plans that support both progress and long-term
          success. We are passionate about empowering our patients to overcome
          barriers and become the best version of who they are.
        </p>

        {/* Facility Section */}
        <h2 className={`${header} text-2xl`}>Our Facility Includes:</h2>
        <p>
          ...
          where patients can achieve their goals. We are proud to offer a range
          of specialized equipment, a vibrant sensory gym full of swings,
          trampolines, ball pits, and one-on-one therapy rooms to ensure privacy
          and comfort for each patient.
        </p>

        {/* Call to Action */}
        <h2 className={`${header} text-2xl`}>Take the First Step Today!</h2>
        <p>
          The path to a better tomorrow starts with the right support. Contact
          us now to schedule your evaluation and discover how occupational
          therapy can transform your life and the life of your loved one. Your
          goals are within reach ~ let us help you achieve them!
        </p>
      </div>
    </div>
  );
