export const adultFaqTopics = [
  {
    slug: 'what-is-voice-therapy',
    title: 'What is Voice Therapy?',
    content: () => (
      <>
  ...
  {
    slug: 'cognition-and-linguistic-rehabilitation',
    title: 'What is Cognition and Linguistic Rehabilitation?',
    content: () => (
      <>
        <div className="mt-3 text-base text-gray-700 leading-relaxed space-y-3">
          <p>
